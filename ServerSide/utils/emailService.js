...
const sendOTPEmail = async (email, otp) => {
  const subject = 'AgriLink - Email Verification OTP';
  const message = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
      <h2 style="color: #10B981; text-align: center;">AgriLink Email Verification</h2>
      <p>Thank you for registering with AgriLink. Please use the following OTP to verify your email address:</p>
